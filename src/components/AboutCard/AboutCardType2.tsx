...
const AboutCard2 = ({
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="mb-1 lg:mb-4 text-2xl lg:text-[3.25em] font-bold text-red-500 dark:text-white lg:text-end">
        {title}
        </h1>
        <p className="pl-1 text-md lg:text-xl font-light text-zinc-700 dark:text-zinc-400 lg:text-end">
          {text}
        </p>
      </div>
    </div>

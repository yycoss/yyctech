export const events = [
  {
    ...
    description: "Gather around at a table with your laptop and code away with friends. The host is Bottlescrew Bills, a pub with various international food, beverage, and dietary options for all the different types of hackers.",
    link: {
      href: 'https://www.meetup.com/yyc-dev/events/303654300',
      label: 'Event Details',
    },
  ...
  {
    name: 'Calgary Game Developers | Monthly Meetup',
    date: '2024-10-17',
    venue: 'Civic Tavern',
    time: '6:00 PM',
    meetup: `https://www.meetup.com/calgary-game-developers`,
    description: "Every third Thursday of every month we have a short presentation or a local community social. Come join us, bring your projects, and meet local video game developers!",
    link: {
      href: 'https://www.meetup.com/calgary-game-developers/events/303695762',
      label: 'Event Details',
    },
    image: '/assets/images/gdcEvent.jpg',
    badge: 'Popular',
    recurrent: true,
    every: '3rd thursday'
  },
  ...
  },
  {
    ...
    description: "Regular meetups, workshops, and seminars featuring industry experts and thought leaders who cover a wide range of topics, from the latest programming languages and frameworks and best practices in software ",
    link: {
      href: 'https://www.meetup.com/calgary-tech-talks1/events/303381290',
      label: 'Event Details',
    },

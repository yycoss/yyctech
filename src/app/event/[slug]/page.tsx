  ...
  return (
    <section className="mx-4 mt-24 flex items-center justify-center lg:mx-10 lg:max-w-7xl xl:mx-auto">
      <div className="flex h-screen max-w-[1280px] flex-col justify-start">
        ...
        <div className="my-5 flex h-full w-full flex-col gap-2 md:flex-row lg:max-h-[450px] lg:gap-5">
                ...
                event.group.link && (
                  ...
                  >
                    <Image
                      ...
                      height={80}
                      alt="group-logo"
                      className="min-h-[80px] min-w-[80px] rounded-xl"
                    />
                  </Link>
                )}
            </div>
